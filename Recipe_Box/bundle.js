...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(186);
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	    ...
	    { store: createStoreWithMiddleware(_Reducer2['default']) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newRec = __webpack_require__(188);

	var _newRec2 = _interopRequireDefault(_newRec);

	var _containersDish = __webpack_require__(190);

	var _containersDish2 = _interopRequireDefault(_containersDish);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { id: 'graybox' },
	          _react2['default'].createElement(_containersDish2['default'], null),
	          _react2['default'].createElement(_button2['default'], null)
	        ),
	        _react2['default'].createElement(_newRec2['default'], null)
	      );
	    }
	  }]);
	   ...
	   _createClass(Button, [{
	      ...
	      value: function render() {
	         return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	               'button',
	               { type: 'button', onClick: this.displayForm },
	               'Add Recipe'
	            )
	         );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionsIndex = __webpack_require__(189);

	var _redux = __webpack_require__(167);

	var Newrec = (function (_Component) {
	  _inherits(Newrec, _Component);

	  function Newrec() {
	    _classCallCheck(this, Newrec);

	    _get(Object.getPrototypeOf(Newrec.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(Newrec, [{
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { id: 'addingreX', onClick: this.hide },
	              _react2['default'].createElement(
	                'center',
	                null,
	                _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('br', null),
	            _react2['default'].createElement('br', null),
	            _react2['default'].createElement('textarea', { id: 'addnewtextA', rows: '4', cols: '25' }),
	            _react2['default'].createElement('br', null),
	            _react2['default'].createElement('br', null),
	    ...
	    value: function submitForm(event) {
	      ...
	      var ingredients = $('#addnewtextA').val();
	...
	function mapDispatchToProps(dispatch) {
	  ...
	  return (0, _redux.bindActionCreators)({ addState: _ActionsIndex.addState }, dispatch);
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Newrec);
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	exports.selectDish = selectDish;
	exports.deleteState = deleteState;
	exports.updateState = updateState;
	exports.getSelectDish = getSelectDish;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsIngrebox = __webpack_require__(191);

	var _componentsIngrebox2 = _interopRequireDefault(_componentsIngrebox);
	...
	var Dish = (function (_Component) {
	  _inherits(Dish, _Component);

	  function Dish() {
	    _classCallCheck(this, Dish);

	    _get(Object.getPrototypeOf(Dish.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(Dish, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { id: 'box' },
	        this.props.mydishes.map(function (curdish) {
	          return [_react2['default'].createElement(
	            'div',
	            { className: 'dishes', id: curdish.dish, onClick: function () {
	                return _this.openIngredientBox(curdish);
	              } },
	            curdish.dish.replace(/_/g, " ")
	          ), _react2['default'].createElement(_componentsIngrebox2['default'], null)];
	        })
	      );
	    }
	  }, {
	    key: 'openIngredientBox',
	    value: function openIngredientBox(mydish) {
	...
	function mapDispatchToProps(dispatch) {
	  ...
	  return (0, _redux.bindActionCreators)({ selectDish: _ActionsIndex.selectDish }, dispatch);
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Dish);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _updateingre = __webpack_require__(192);

	var _updateingre2 = _interopRequireDefault(_updateingre);
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'center',
	          null,
	          _react2['default'].createElement('span', { id: 'recipeName' })
	        ),
	        _react2['default'].createElement(Ingres, null)
	      )
	    );
	  }
	...
	var Ingres = _react2['default'].createClass({
	  displayName: 'Ingres',
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement('ul', { id: 'allingres' })
	    );
	  }

	});

	var IngreBox = (function (_Component) {
	  _inherits(IngreBox, _Component);

	  function IngreBox() {
	    _classCallCheck(this, IngreBox);

	    _get(Object.getPrototypeOf(IngreBox.prototype), 'constructor', this).call(this);

	    this.deleteDish = this.deleteDish.bind(this);
	    this.openEditBox = this.openEditBox.bind(this);
	  }

	  _createClass(IngreBox, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { id: 'circle', onClick: this.hideIngreBox },
	            _react2['default'].createElement(
	              'span',
	              { id: 'x' },
	              _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { id: 'delete', onClick: this.deleteDish },
	            _react2['default'].createElement(
	              'center',
	              null,
	              'Delete'
	          ...
	          _react2['default'].createElement(
	            'div',
	            { id: 'edit', onClick: this.openEditBox },
	            _react2['default'].createElement(
	              'center',
	              null,
	              'Edit'
	        ...
	        _react2['default'].createElement(_updateingre2['default'], null)
	      );
	    }
	  }, {
	    key: 'hideIngreBox',
	    value: function hideIngreBox() {
	      $('#ingredientBox').css('visibility', 'hidden');
	    }
	  }, {
	    key: 'openEditBox',
	    value: function openEditBox() {
	    ...
	    value: function deleteDish() {
	      ...
	      var curdish = this.props.myactived[0];

	      var grayboxheight = $('#graybox').height();
	...
	function mapDispatchToProps(dispatch) {
	  ...
	  return (0, _redux.bindActionCreators)({ deleteState: _ActionsIndex.deleteState }, dispatch);
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(IngreBox);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editingre = (function (_Component) {
	  _inherits(Editingre, _Component);

	  function Editingre() {
	    _classCallCheck(this, Editingre);

	    _get(Object.getPrototypeOf(Editingre.prototype), 'constructor', this).call(this);

	    this.submitEditBox = this.submitEditBox.bind(this);
	  }

	  _createClass(Editingre, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'form',
	            { onSubmit: this.submitEditBox },
	            _react2['default'].createElement(
	              'div',
	              { id: 'editingreX', onClick: this.hideEditBox },
	              _react2['default'].createElement(
	                'center',
	                null,
	                _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('textarea', { rows: '7', cols: '11', id: 'newingredients' }),
	            _react2['default'].createElement('input', { type: 'submit', id: 'submitnewingre' })
	          )
	        )
	      );
	    }
	    ...
	    key: 'hideEditBox',
	    value: function hideEditBox() {
	      $('#editbox').css('visibility', 'hidden');
	    }
	  }, {
	    key: 'submitEditBox',
	    value: function submitEditBox(event) {

	      var newingres = $('#newingredients').val();
	      this.props.getSelectDish();

	      var curdish = this.props.myactivedish[0];
	      var dishname = curdish.dish;

	      newingres = newingres.split(',');

	      this.props.updateState({ dish: dishname, 'in': newingres });

	      var hi = this.props.mydishes[0];
	...
	function mapDispatchToProps(dispatch) {
	  ...
	  return (0, _redux.bindActionCreators)({ updateState: _ActionsIndex.updateState, getSelectDish: _ActionsIndex.getSelectDish }, dispatch);
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Editingre);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_dish = __webpack_require__(194);

	var _reducer_dish2 = _interopRequireDefault(_reducer_dish);

	var _reducer_active = __webpack_require__(195);

	var _reducer_active2 = _interopRequireDefault(_reducer_active);

	var rootReducer = (0, _redux.combineReducers)({
	     mydish: _reducer_dish2['default'],
	     activedish: _reducer_active2['default']
	});
...
/***/ function(module, exports) {
	...
	exports['default'] = function (state, action) {
	  if (state === undefined) state = [{ dish: 'Spaghetti', 'in': ['Noodles', 'Tomato Sauce', '(Optional) Meatballs'] }, { dish: 'Onion_Pie', 'in': ['Onion', 'Pie Crust'] }];
